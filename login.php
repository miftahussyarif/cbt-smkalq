...
<body class="font-medium">
        ...
        <div id="myerror" class="alert alert-danger" role="alert"
            ...
            if (isset($_REQUEST['salah'])) {
                if ($_REQUEST['salah'] == 2) {
                    ...
                    echo "<b><li style='padding-bottom:5px'>Username atau Password anda salah</li></b>";
                } elseif ($_REQUEST['salah'] == 3) {
                    echo "<b><li style='padding-bottom:5px'>Anda Sudah Login di tempat lain</li></b>";
    ...
    <div class="col-md-4 col-md-offset-4 login-wrapper" id="panel_login"
        style="float:inherit; margin-top:0px; min-width:400px;  max-width:500px;">
                    ...
                    <div class="form-horizontal" style="margin-top:30px"><br>
                        ...
                        <div class="form-group error">
                            ...
                            <div class="col-sm-8 input-wrapper">
                                ...
                                <input class="form-control" style="width:87%; height:37px; margin-left:38px"
                                    data-val="true" data-val-required="User name wajib diisi" id="inputUsername"
                                    name="UserName" placeholder="Username" type="text" value="">
                                <span class="hide error-message"><span class="field-validation-valid"
                                        data-valmsg-for="UserName" data-valmsg-replace="true"></span></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 input-wrapper">
                                ...
                                <input class="form-control" style="width:87%; height:37px; margin-left:38px"
                                    data-val="true" data-val-required="Password wajib diisi" id="inputPassword"
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-8 text-right">
                                <button type="submit" class="btn btn-success btn-block doblockui"
                                    onClick="validateAndSend()">LOGIN</button>
                            </div>
                        </div>
    ...
    <div id="buntut">
        ...
        <div style="margin-top:130px; bottom:50px; background-color:#dcdcdc; padding:7px; font-size:12px">
            <div class="content">
                CBT.SMKALQ.Web:<strong>3.0</strong><br>
