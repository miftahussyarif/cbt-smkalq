...
left join cbt_mapel m on u.XKodeMapel = m.XKodeMapel WHERE u.XKodeSoal='$xkodesoal' and u.XStatusUjian = '1'");
		...
		and j.XUserJawab = '$user' and j.XTokenUjian = '$xtokenujian' and j.XJenisSoal = '1' order by j.Urut");
                ...
                while ($s = mysql_fetch_array($sql)) {
                    ...
                    <div class="item" id="kotakz<?php echo $s['Urut']; ?>"
                        style="background-color:<?php echo $cssb; ?>; color:<?php echo $csst; ?>;border-color:<?php echo $border; ?>">
                        <p
                            style="margin-top:-9px; margin-left:-9px; font-family:Arial, Helvetica, sans-serif; font-size:24px">
                        ...
                        <div id='noti-count' style="border-color:<?php echo $border; ?>">
                            <div>
                                ...
                                if ($jensoal == 2) {
                                    if (!$jwbsoal == '') {
                                        echo "<img src=images/ijo.png style='margin-left:-5px;margin-top:-3px'>";
                                    } else {
                                        echo "";
                                    }
                                } else {
...
<a style="top:150px; right: -42px;" href="javascript:AlertIt();" class="toggleBtn" id="toggleLink">
    <div id="awal" align="center" style="display:none">
        <font size="+3"> > </font>
    </div>
    <div id="ahir" style="display:block">
        <table border="0">
            <tr>
                ...
                <td>
                    <font size="-1" color="#FFFFFF">DAFTAR</font> <br>
                    <font size="-1" color="#FFFFFF"> SOAL</font>
                </td>
            </tr>
        </table>
    </div>
...
!-->
                ...
                <?php
                if ($jensoal == 2) {
                    echo "<span style='color:red; font-size:12px;'>Pertanyaan Essai : Jawablah Pertanyaan Berikut ini<br></span>";
                } ?>
                            ...
                            <div class="panel-footer">
                                <div class="row" style="background-color:#fff">
                                    ...
                                    <div class="col-xs-6 col-center" style="margin-left:25%">
                                        <button data-bind="click: handleNotConfirm" type="submit"
                                            class="btn btn-danger btn-block" data-dismiss="modal"
                                            id="lanjut">Tutup</button></a>
                                    </div>
                                </div>
                            </div>
...
!-->
                ...
                if ($jensoal == 1) {
                    ...
                    <table border="0" cellpadding="0px" cellspacing="0px">
                        ...
                        <tr>
                            <td valign="top"><input id="B" type="radio" name="credit-card" value="B" <?php echo $nilaiB; ?>>
                        ...
                        <tr>
                            <td valign="top"><input id="C" type="radio" name="credit-card" value="C" <?php echo $nilaiC; ?>>
                                <label class="drinkcard-cc C" for="C">&nbsp;</label>
                            </td>
                        ...
                        <tr>
                            <td valign="top"><input id="D" type="radio" name="credit-card" value="D" <?php echo $nilaiD; ?>>
                                <label class="drinkcard-cc D" for="D">&nbsp;</label>
                            </td>
                            <?php if (str_replace("  ", "", $result['XGambarJawab4']) == '') {
                            } else {
                            ...
                            <td class="pilihanjawaban" valign="top"><?php echo "$jwbD"; ?></td>
                        </tr>
                        <?php if ($sopil > 4) { ?>
                            <tr>
                                <td valign="top"><input id="E" type="radio" name="credit-card" value="E" <?php echo $nilaiE; ?>>
                                    <label class="drinkcard-cc E" for="E">&nbsp;</label>
                                </td>
                                <?php if (str_replace("  ", "", $result['XGambarJawab5']) == '') {
                                } else {
                                ...
                                <td class="pilihanjawaban" valign="top"><?php echo "$jwbE"; ?></td>
                            </tr>
                        <?php } ?>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="inner-content">
                                        <div class="row" style="background-color:#fff">
                                            <?php
                                            if (str_replace("  ", "", $result['XGambarTanya']) == '') {
                                            } else {
    ...
    <section class="page-section soal-navigation">
        <div class="container1" style="margin-left:-30px;">
            <div>
                ...
                ?>
                <button id="btnPrevSoal" class="btn btn-default btn-prev" data-bind="click: gotoBack">SOAL
                    SEBELUMNYA</button>
                </a>
            </div>
            <?php
            ...
            <div><label class="labele" style="padding-bottom:10px; padding-top:10px; width:225px">
                    <input type="checkbox" id="<?php echo $stu; ?>" onClick="toggle_select(<?php echo $stu; ?>)" <?php if (isset($ragu)) {
                              echo $ragu;
                          } ?> />&nbsp;RAGU-RAGU</label>
            </div>
                ...
                if (isset($next_id)) {
				   ...
				   and XUserJawab = '$user'"));
                        ...
                        <button id="btnNextSoal" class="btn btn-primary btn-next activebutton"
                            data-bind="css: { &#39;activebutton&#39;:(currentNo() &lt; totalQuestions - 1)}, visible: (currentNo() &lt; totalQuestions - 1),click: gotoNext"
                            style="margin-top:-13px; width:225px">SOAL BERIKUTNYA</button><?php // echo "|$next_id|"; 
                ...
                <div class="panel-footer">
                    <div class="row" style="background-color:#fff">
                        <div class="col-xs-offset-3 col-xs-6">
                            <button id="btnLanjut" data-bind="click: redirectToDone" type="submit"
