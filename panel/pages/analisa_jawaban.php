        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <table width="100%">
                        <tr>
                            <td><a href="?modul=analisasoal"><button class="btn btn-default">
                                        <i class="fa fa-arrow-circle-left"></i> Kembali ke Daftar</button></a> Daftar
                                Peserta Ujian</td>
                            <td align="right">

                                <a href=?modul=analisabutir&soal=<?php echo $_REQUEST['soal']; ?>><button type="button"
                                        class="btn btn-primary btn-small">
                                        <i class="fa fa-file-text"></i> Analisa Butir Soal </button></a>

                                <a href=?modul=rekapesai&soal=<?php echo $_REQUEST['soal']; ?>><button type="button"
...
?>
                            ...
                            <tr class="odd gradeX">
                                <td><input type="hidden" value="<?php echo $so; ?>" id="txt_mapel<?php echo $so; ?>">
                                    <?php echo $so; ?>
                                </td>
                                <td>
                                    <?php echo $s['XNomerUjian']; ?>
                                </td>
                                <td align="center">
                                    <?php echo $s['XKodeUjian']; ?>
                                </td>
                                <td>
                                    <?php echo $s['XNamaSiswa']; ?>
                                </td>
                                <td align="center">
                                    <?php echo $s['XKodeKelas']; ?>
                                </td>
                                <td align="center">
                                    <?php echo $s['XKodeJurusan']; ?>
                                </td>
                                <td align="center">
...
?>
                            ...
                            <script>
                                $(document).ready(function () {
                                    $("#simpan<?php echo $so; ?>").click(function () {
                                        //alert("<?php echo $so; ?>");
                                        ...
                                        var txt_mapel = $("#txt_mapel<?php echo $so; ?>").val();
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (data) {
                                                if ($("#simpan<?php echo $so; ?>").hasClass("btn-success")) {
                                                    $("#simpan<?php echo $so; ?>").removeClass("btn-success").addClass("btn-default");
                                                    $("#simpan<?php echo $so; ?>").val("Non Aktif");
                                                } else {
                                                    $("#simpan<?php echo $so; ?>").removeClass("btn-info").addClass("btn-success");
                                                    $("#simpan<?php echo $so; ?>").val("Aktif");
                                                }
                                                loading.fadeOut();
                                                tampilkan.html(data);
                                                tampilkan.fadeIn(100);
                                    ...
                                    $("#acak<?php echo $so; ?>").click(function () {
                                        //alert("<?php echo $so; ?>");
                                        var txt_ujian = $("#txt_ujian").val();
                                        var txt_jawab = $("#txt_jawab").val();
                                        var txt_acak = $("#switch_left").val();
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (data) {
                                                ...
                                                if ($("#acak<?php echo $so; ?>").hasClass("btn-success")) {
                                                    $("#acak<?php echo $so; ?>").removeClass("btn-success").addClass("btn-warning");
                                                    $("#acak<?php echo $so; ?>").val("Tidak");
                                                } else {
                                                    $("#acak<?php echo $so; ?>").removeClass("btn-warning").addClass("btn-success");
                                                    $("#acak<?php echo $so; ?>").val("Acak");
                                                }
                                    ...
                                    $("#hapus<?php echo $so; ?>").click(function () {
                                        //	 alert("<?php echo $so; ?>");
                                        var txt_ujian = $("#txt_ujian").val();
                                        var txt_jawab = $("#txt_jawab").val();
                                        var txt_acak = $("#switch_left").val();
                                    ...
                                    $('#btnDelete<?php echo $so; ?>').on('click', function (e) {
