...
$so = mysql_fetch_array($sqltanya); ?>
        ...
        <div class="panel panel-info">
            ...
            <script type="text/javascript"
                src="jscripts/tiny_mce/plugins/asciimath/js/ASCIIMathMLwFallback.js"></script>
            <script type="text/javascript">
                    ...
                    <tr>
                        <td colspan="3">
                            <div class="col-sm-12"><label
                                ...
                                <input type="text" id="txt_kate" name="txt_kate" value="2" readonly size="1"
...
?>
                                ...
                                <tr>
                                    <td align="center"><br>
                                        <div id="upload" style="text-align:center; padding-right:10;"><img
                                                src="<?php echo $ico_gbrx; ?>" width="130" style="margin-top:10" />
            ...
            <td align="center"> <br>
                <div id="upload2" style="text-align:center"><img src="<?php echo $ico_audx; ?>" width="130" /></div>
