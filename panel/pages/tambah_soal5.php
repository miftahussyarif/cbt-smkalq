      ...
      <div class="panel-body">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td align="right">
              <button type="submit" class="btn btn-success btn-small" id="kirim"><i class='fa fa-save'></i> Simpan
                Soal</button>
...
$maks = $sm['maksi'] + 1; ?>
          ...
          <td colspan="3" align="right"><textarea name="tanyasoal" id="tanyasoal"
              style="font-size:18px; width:100%; height:300px">
		...
		<a href="javascript:;" onmousedown="tinyMCE.get('elm1').hide();">[Hide]</a>  -->
              ...
              <a href="javascript:;" onMouseDown="alert(tinyMCE.get('elm1').selection.getContent());">[Get selected
                HTML]</a>
              <a href="javascript:;"
          ...
          <tr>
            <td colspan="3"><br>
              ...
              <table cellpadding="10" width="70%" align="center" cellspacing="10">
                ...
                <tr>
                  <td align="center"><br>
                    <div id="upload" style="text-align:center; padding-right:10;"><img src="images/no_pic.png"
...
//					$('<li></li>').appendTo('#files').html('<img src="./uploads/'+file+'" alt="" /><br />'+file).addClass('success');
    ...
    <tr>
      ...
      <td width="100%" colspan="3">Tekan tombol untuk mengaktifkan Opsi Jawaban
    ...
    <tr>
      ...
      <td align="right" colspan="2"><textarea name="tanya" id="jawab<?php echo $i; ?>"
		...
		<a href="javascript:;" onmousedown="tinyMCE.get('elm1').hide();">[Hide]</a>  -->
          ...
          <a href="javascript:;" onMouseDown="alert(tinyMCE.get('elm1').selection.getContent());">[Get selected
            HTML]</a>
          <a href="javascript:;" onMouseDown="alert(tinyMCE.get('elm1').selection.getContent({format : 'text'}));">[Get
            selected text]</a>
        </div>
      </td>
    </tr>
