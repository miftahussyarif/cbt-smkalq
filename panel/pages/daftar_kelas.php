...
Tambah Kelas</button>
<?php echo "</a>";?>                            
                            <a href="?modul=upl_kelas" class="btn btn-success btn-small" style="margin-left:8px;">
                                <i class="fa fa-upload"></i> Upload Kelas
                            </a>
                        </div>
                        <!-- /.panel-heading -->
...
function myFunction<?php echo $s['Urut']; ?>() {
  ...
  <!-- Button trigger modal -->
                            ...
                            <!-- /.table-responsive -->
                            <div class="well">
                                <h4>CBT SMK AL QODIRIYAH</h4>
                                <p>Developed by Muhammad Miftahus Syarif</p><p>
                                </p>
                            </div>
                        </div>
                        <!-- /.panel-body -->
