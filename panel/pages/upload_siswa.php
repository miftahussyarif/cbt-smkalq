        ...
        <div class="panel panel-green">
            ...
            <div class="panel-body">
                <div style="width: 20%; float:left">
                    <a href="../../file-excel/bee_siswa_temp.xls" target="_blank"><img src="images/xls.png"
                            style=" width:90%; max-width:100px;padding-right:10px;" /></a>
                </div>

                <div style="width: 80%; float:right">
                    Silahkan Klik logo Excel disamping, untuk <a href="../../file-excel/bee_kelas_temp.xls"
                        target="_blank"> download </a> file excel database Siswa.
                    <br />Jangan ada inputan apapun setelah nomer terakhir. Karena akan dibaca dan diacak oleh sistem.
                    <p>Setelah selesai edit, Upload kembali untuk ditransfer ke
                        database melalui tool dibawah ini.

                </div>
            </div>
            <div class="panel-footer">
                <a href="../../file-excel/bee_siswa_temp.xls" target="_blank"><button
                        class="btn btn-success btn-lg btn-small" id="baru" value="Buat" name="baru"><i
                            class="fa fa-file-excel-o"></i>
                        Download</button></a>

                <a href="?modul=daftar_siswa"><button class="btn btn-success btn-lg btn-small" id="baru" value="Buat"
                        name="baru"><i class="fa fa-search"></i>
                        Lihat Data</button></a>
            </div>
        </div>
        <!-- /.col-lg-4 -->
            ...
            <div class="panel-body">
                <form method="post" enctype="multipart/form-data" action="<?php echo "?modul=uploadsiswa"; ?>">
                    ...
                    <table border="0" width="78%" cellpadding="20px" cellspacing="20px">
                        <tr>
                            <td width="30%"><input name="userfile" type="file" class="btn btn-default"
                                    style="width:250px"></td>
                            <td>
                                &nbsp;<input name="upload" type="submit" value="Import" class="btn btn-info"
                ...
                if ($_REQUEST['modul'] == "uploadsiswa") {
                    ...
                    if (!isset($_FILES['userfile']) || $_FILES['userfile']['error'] != 0 || !is_readable($_FILES['userfile']['tmp_name'])) {
                        echo "<div class='alert alert-danger'>Error: File tidak dapat dibaca atau tidak valid. Pastikan file sudah dipilih dengan benar.</div>";
                    } else {
