...
$maks = $sm['maksi'] + 1; ?>
			...
			<div class="panel-body">
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td align="right">
							<button type="submit" class="btn btn-success btn-small" id="kirim"><i
									class='fa fa-save'></i> Simpan Soal</button>
					...
					<tr>
						<td colspan="3">
							<div class="col-sm-12"><label
									style="width:100px; font-style:normal; font-weight:normal">Jenis Soal</label>
								<input type="text" id="txt_kate" name="txt_kate" value="1" readonly size="1"
							...
							<div class="col-sm-12"><label
									style="width:100px; font-style:normal; font-weight:normal">Acak Soal</label>
							...
							<div class="col-sm-12"><label
									style="width:100px; font-style:normal; font-weight:normal">Acak Jawaban</label>
					...
					<td colspan="3" align="right"><textarea name="tanyasoal" id="tanyasoal"
							style="font-size:18px; width:100%; height:300px"></textarea></td>
					</tr>
					...
					<tr>
						<td colspan="3"><br>
							<table cellpadding="10" width="70%" align="center" cellspacing="10">
								...
								<tr>
									<td align="center"><br>
										<div id="upload" style="text-align:center; padding-right:10;"><img
												src="images/no_pic.png" width="130" style="margin-top:10" /></div><span
											id="status"></span>
										<ul id="files"></ul>
			</div><input type="text" id="gambar" name="gambar">
			</td>
			<td align="center"> <br>
				<div id="upload2" style="text-align:center"><img src="images/no_aud.png" width="130" /></div><span
					id="status2"></span>
				<ul id="files2"></ul>
		...
		<td align="center"> <br>
			<div id="upload3" style="text-align:center"><img src="images/no_vid.png" width="130" /></div><span
				id="status3"></span>
			<ul id="files3"></ul>
		...
		<tr>
			<td width="100px" height="50px">
				<p style="margin-top:8px;margin-left:10px"><input type="radio" name="radio1" value="<?php echo $i; ?>"
						class="lcs_check lcs_tt2" autocomplete="off"></p>
			</td>
			<td width="95%" colspan="2">Tekan tombol untuk mengaktifkan Opsi Jawaban
		...
		<tr>
			<td>
				<div class="col-sm-12"> <span>Gambar Jawaban
						...
						<div id="upload<?php echo $var; ?>" style="text-align:center; padding-right:10;"><img
								src="images/no_pic.png" width="130" style="margin-top:10" /></div><span
							id="status<?php echo $var; ?>"></span>
			...
			<td align="right" colspan="2"><textarea name="tanya" id="jawab<?php echo $i; ?>"
					style="font-size:18px; width:95%; height:150px"></textarea>
				<div>
					<!-- Some integration calls: the first two seem to be having issues with asciimath plugin
		<a href="javascript:;" onmousedown="tinyMCE.get('elm1').show();">[Show]</a>
		<a href="javascript:;" onmousedown="tinyMCE.get('elm1').hide();">[Hide]</a>  -->
					<a href="javascript:;" onMouseDown="alert(tinyMCE.get('elm1').getContent());">[Get contents]</a>
					<a href="javascript:;" onMouseDown="alert(tinyMCE.get('elm1').selection.getContent());">[Get
						selected HTML]</a>
					<a href="javascript:;"
						onMouseDown="alert(tinyMCE.get('elm1').selection.getContent({format : 'text'}));">[Get selected
						text]</a>
				</div>
