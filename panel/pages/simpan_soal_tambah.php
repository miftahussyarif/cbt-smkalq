...
$sss = str_replace("  ", "", $sss);
$sss = mysql_real_escape_string($sss);
...
$txt_jawab1 = mysql_real_escape_string(isset($_REQUEST['txt_jawab1']) ? $_REQUEST['txt_jawab1'] : '');
$txt_jawab2 = mysql_real_escape_string(isset($_REQUEST['txt_jawab2']) ? $_REQUEST['txt_jawab2'] : '');
$txt_jawab3 = mysql_real_escape_string(isset($_REQUEST['txt_jawab3']) ? $_REQUEST['txt_jawab3'] : '');
$txt_jawab4 = mysql_real_escape_string(isset($_REQUEST['txt_jawab4']) ? $_REQUEST['txt_jawab4'] : '');
$txt_jawab5 = mysql_real_escape_string(isset($_REQUEST['txt_jawab5']) ? $_REQUEST['txt_jawab5'] : '');
