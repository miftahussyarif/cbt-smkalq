                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <table width="100%"><tr><td>Paket Tes yang Aktif</td><td align="right">
                                        </td></tr>
							</table>
                        </div>
                        <!-- /.panel-heading -->
				...
				if($sqlsoal<1){$kata="disabled";}  else {$kata="";}	
							?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td align="center"><a href="#myJadwal<?php echo $s['Urutan']; ?>" data-toggle="modal">
										<button class="btn btn-info" <?php echo $kata; ?> ><i class='fa fa-clock-o fa-fw'></i> Set Jadwal</button></a>
										</td>                                    
                                    </tr>
 <!-- Modal Jadwal -->
 <script>/*
