...
?>
              ...
              <tr class="odd gradeX">
                <td><input type="hidden" value="<?php echo $s['Urutan']; ?>" id="txt_mapel<?php echo $ururut; ?>">
                  <?php echo $s['Urutan']; ?>
                </td>
                <td>
                  <?php echo $s['XKodeSoal']; ?>
                </td>
                <td>
                  <?php echo $s['XKodeMapel'] . " " . $s['XNamaMapel']; ?>
                </td>
                <td>
                  <?php echo "$sqlsoal (" . $s['XJumPilihan'] . " opsi)"; ?>
                </td>
                <td>
                  <?php echo $s['kokel'] . " | " . $s['XKodeJurusan'] . "."; ?>
                </td>
                <td>
                  <?php echo "$ttglujian $tjamujian"; ?>
                </td>
                <td>
                  <?php echo $ststsesi; ?>
                </td>
                <td>
                  <?php if ($sttsujian == "1") { ?>
                  <input type="button" id="simpan<?php echo $ururut; ?>" class="btn btn-success" value="Aktif" <?php
                    echo $katapakai; ?> disabled>
                  <?php
    }
    else { ?>
                  <input type="button" id="simpan<?php echo $ururut; ?>" class="btn btn-default" value="Non Aktif">
                  <?php
    }?>
                </td>
                <td>
              ...
              <?php
  } // close ujian/sesi loop

  // Jika paket soal tidak punya ujian aktif, tetap tampilkan 1 row dengan info paket soal
  if (!$has_ujian) { ?>
              <tr class="odd gradeX">
                <td><input type="hidden" value="<?php echo $s['Urutan']; ?>" id="txt_mapel<?php echo $s['Urutan']; ?>">
                  <?php echo $s['Urutan']; ?>
                </td>
                <td>
                  <?php echo $s['XKodeSoal']; ?>
...
$('#console').html($('#console').html()+'<br>'+errorMsg)
              ...
              <div class="modal fade" id="myJadwal<?php echo $s['Urutan']; ?>" tabindex="-1" role="dialog"
...
?>
                      ...
                      <p> <span class="asd" class="asd">Durasi Tes </span><span>: <input type="text" size="3"
                            id="txt_durasi<?php echo $s['Urutan']; ?>"> menit </span></p>
                      <p> <span class="asd" class="asd">
                          Maksimum Keterlambatan </span><span>: <input type="text" size="3"
                            id="txt_telat<?php echo $s['Urutan']; ?>">
                          <input type="hidden" size="3" id="txt_kodesoal<?php echo $s['Urutan']; ?>"
                            value="<?php echo $s['XKodeSoal']; ?>">
                          menit </span>
                        <font color="#cd0202">*</font>
                      </p>
                      <p> <span class="asd" class="asd">Token </span><span>: <input type="text" size="10"
                            id="txt_token<?php echo $s['Urutan']; ?>"></span></p>
                      <p> <span class="asd" class="asd"> </span><button type="button" class="btn btn-info btn-small"
                          id="kirim<?php echo $s['Urutan']; ?>"> Rilis Token </i></button> </span></p>
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-default" data-dismiss="modal"
                        onClick="myFunction()">Close</button>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="well">
        <li>
          <font color="#FF0033">*Bank Soal Yang dipakai Seluruh Kelas dan Jurusan harus berdiri sendiri. TIDAK BOLEH
            AKTIF dengan Bank Soal lain</font>
        </li>
        ...
        <li>Daftar diatas merupakan Paket Soal yang sudah diaktifkan oleh Guru. Silahkan melakukan pengaturan Jadwal
          ujian (Klik tombol 'Set' pada Menu Jadwal)</li>
