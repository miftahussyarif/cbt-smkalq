...
?>
      <div class="panel-body">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td colspan="2" style="font-size:18px"><b> &nbsp;ID Soal
                <?php echo $_REQUEST['nomer']; ?>
              </b></td>
            <td align="right">
              <button type="submit" class="btn btn-success btn-small" id="kirim"><i class='fa fa-save'></i> Update
                Soal</button>
          ...
          <tr>
            <td colspan="3">
              <div class="col-sm-12"><label style="width:100px; font-style:normal; font-weight:normal">Jenis
                  Soal</label>
                <input type="text" id="txt_kate" name="txt_kate" value="1" readonly size="1" style="margin-bottom:5px">
              </div>
              <div class="col-sm-12"><label style="width:100px; font-style:normal; font-weight:normal">Tk.
                  Kesulitan</label>
                <select id="txt_kes" name="txt_kes" class="input-sm" style="margin-bottom:5px" />
                <option value="1" <?php if ($s['XKategori'] == '1' ) {
  echo "selected" ;
}?>>Mudah</option>
                <option value="2" <?php if ($s['XKategori'] == '2' ) {
  echo "selected" ;
}?>>Sedang</option>
                <option value="3" <?php if ($s['XKategori'] == '3' ) {
  echo "selected" ;
}?>>Sulit</option>
                </select>
              </div>
              <div class="col-sm-12"><label style="width:100px; font-style:normal; font-weight:normal">Acak Soal</label>
                ...
                <option value="A" <?php if ($s['XAcakSoal'] == 'A' ) {
  echo "selected" ;
}?>>Acak</option>
                <option value="T" <?php if ($s['XAcakSoal'] == 'T' ) {
  echo "selected" ;
}?>>Tidak</option>
                </select>
              </div>
              <div class="col-sm-12"><label style="width:100px; font-style:normal; font-weight:normal">Acak
                  Jawaban</label>
                <select id="txt_ops" name="txt_ops" class="input-sm" />
                <option value="Y" <?php if ($s['XAcakOpsi'] == 'Y' ) {
  echo "selected" ;
}?>>Acak</option>
                <option value="T" <?php if ($s['XAcakOpsi'] == 'T' ) {
  echo "selected" ;
}?>>Tidak</option>
                </select>
              </div>
...
echo "$s[XTanya]"; ?></textarea>
          ...
          <tr bgcolor="#507db3">
            <td colspan="3" style="padding:10px">
              <font color="#FFFFFF" size="5"><b>&nbsp;File Pendukung Soal</b></font>
            </td>
          </tr>
          <tr>
            <td colspan="3">
          ...
          <tr>
            <td colspan="3"><br>
              ...
              <?php
if ($s['XAudioTanya'] == "") {
  $ico_audx = "images/no_aud.png";
  $file_audx = "";
}
else {
  $ico_audx = "images/mp3.png";
  $file_audx = "$s[XAudioTanya]";
}
if ($s['XVideoTanya'] == "") {
  $ico_vidx = "images/no_vid.png";
  $file_vidx = "";
}
else {
  $ico_vidx = "images/vid.png";
  $file_vidx = "$s[XVideoTanya]";
}
if ($s['XGambarTanya'] == "") {
  $ico_gbrx = "images/no_pic.png";
  $file_gbrx = "";
}
else {
  $ico_gbrx = "../../pictures/$s[XGambarTanya]";
  $file_gbrx = "$s[XGambarTanya]";
}
?>
              <table cellpadding="10" width="70%" align="center" cellspacing="10">
                ...
                <tr>
                  <td align="center"><br>
                    <div id="upload" style="text-align:center; padding-right:10;"><img src="<?php echo $ico_gbrx; ?>"
                        width="130" style="margin-top:10" /></div><span id="status"></span>
                    <ul id="files"></ul>
      </div>
      ...
      <td align="center"> <br>
        <div id="upload2" style="text-align:center"><img src="<?php echo $ico_audx; ?>" width="130" /></div><span
          id="status2"></span>
        <ul id="files2"></ul>
    </div>
    ...
    <td align="center"> <br>
      <div id="upload3" style="text-align:center"><img src="<?php echo $ico_vidx; ?>" width="130" /></div><span
        id="status3"></span>
      <ul id="files3"></ul>
      </div>
...
//					$('<li></li>').appendTo('#files').html('<img src="./uploads/'+file+'" alt="" /><br />'+file).addClass('success');
    ...
    <tr bgcolor="#507db3">
      <td colspan="4" style="padding:10px">
        <font color="#FFFFFF" size="5"><b>&nbsp;Pilihan Jawaban Soal Multiple Choices</b></font>
      </td>
    </tr>
    <tr>
      <td colspan="4">
    ...
    <tr>
      <td width="90px" height="50px">
        <p style="margin-top:8px;margin-left:10px"><input type="radio" name="radio1" value="<?php echo $i; ?>"
            class="lcs_check lcs_tt2" autocomplete="off" <?php if ($i == $kuncijwb) {
    echo "checked='checked'" ;
  }?> ></p>
      </td>
      <td colspan="3">&nbsp;Tekan tombol untuk mengaktifkan Opsi Jawaban
        <?php echo $i; ?> sebagai Kunci Jawaban
      </td>
    </tr>
    <tr>
      <td colspan="2" align="left" width="300" valign="top">
        <br>
        <div class="col-sm-12"> <span>&nbsp;&nbsp;Gambar Jawaban
            <?php echo $i; ?>
          </span><span>
            <?php
...
?>
            ...
            <div id="upload<?php echo $var; ?>" style="text-align:center; padding-right:10;">
              <?php echo $gbrpic; ?>
            </div><span id="status<?php echo $var; ?>"></span>
      ...
      <td align="right" colspan="2"><textarea name="tanya" id="jawab<?php echo $i; ?>"
          style="font-size:18px; width:95%; height:150px"><?php
  $sql0 = mysql_query("select * from cbt_soal where XKodeSoal= '$_REQUEST[soal]' and Urut = '$_REQUEST[nomer]'");
  $s = mysql_fetch_array($sql0);
  ...
  <!-- Modal -->
  <div class="modal fade" id="myModal<?php echo $s['XNomerUjian']; ?>" tabindex="-1" role="dialog"
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">
            <?php echo "Peserta Ujian : $s[XNomerUjian]"; ?>
          </h4>
        </div>
