        ...
        <div class="modal-content">
            <div class="panel-default">
                <div class="panel-heading">
                    ...
                    CBT SMK AL QODIRIYAH  V3.0 by <a href=" " target="_blank">MUHAMMAD MIFTAHUS SYARIF </a>| Find us on Facebook <a href=" "><img src="images/fb.png"> </a> </h1>
                </div>
                <div class="panel-body">
                    <div class="inner-content">
                        <div class="wysiwyg-content">
                            ...
                            to Watch CBT BeeSMART on <a href=" " target="_blank">
                            <img src="images/youtube.png" width="100"></a> or Join us on <a href=" " target="_blank">
...
<?php
$sqk = db_query($db, "SELECT * FROM cbt_tes WHERE XKodeUjian IN ('UH','UTS','UAS') ORDER BY Urut", array());
...
<?php
$sqk = db_query($db, "SELECT * FROM cbt_tes ORDER BY Urut", array());
while ($rs = $sqk->fetch()) {
    echo "<option value='{$rs['XKodeUjian']}'>{$rs['XNamaUjian']}</option>";
}
?>
